...
let returnArgType = (args) => {
	if ((/.+youtube\.com\/watch\?v=.+&list=.+/u).test(args.join(' ')) == true) return 'playlist';
	if ((/.+youtube\.com\/playlist\?list=.+/u).test(args.join(' ')) == true) return 'playlist';
